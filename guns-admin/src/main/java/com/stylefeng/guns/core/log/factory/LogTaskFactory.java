...
public class LogTaskFactory {
    ...
    private static OrderLogMapper orderLogMapper = Db.getMapper(OrderLogMapper.class);
    ...
    public static TimerTask orderLog(final Integer userId, final String bussinessName, final String clazzName, final String methodName, final String msg,String sn) {
        return new TimerTask() {
        	@Override
            public void run() {
                OrderLog orderLog = LogFactory.createOrderLog(
                        LogType.BUSSINESS, userId, bussinessName, clazzName, methodName, msg, LogSucceed.SUCCESS,sn);
                try {
