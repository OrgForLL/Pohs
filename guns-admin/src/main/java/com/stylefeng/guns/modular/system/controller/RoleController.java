...
public class RoleController extends BaseController {
    ...
    public List<ZTreeNode> roleTreeList() {
    	Integer nowadminid = ShiroKit.getUser().getRoleList().get(0);
        List<ZTreeNode> roleTreeList = this.roleDao.roleTreeList(nowadminid);
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable Integer userId) {
        ...
        if (ToolUtil.isEmpty(roleid)) {
            ...
            List<ZTreeNode> roleTreeListByUserId = this.roleDao.roleTreeListByRoleId(strArray,nowadminid);
